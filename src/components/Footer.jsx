...
const Footer = () => {
  return (
    <div className="px-2 md:px-6 lg:px-20 bg-[#5B3702] text-white">
      <div className="flex items-start justify-between border-b-[1px] py-10">
        <div className="space-y-2">
          ...
          <div className="flex items-start justify-between py-2 pl-2 pr-3 lg:pr-4 border-white border-[1px]  bg-transparent text-[16px] font-normal font-poppin">
            <input
              type="text"
