      ...
      <div className="px-4 md:px-6 lg:px-20 py-6 shadow-md  bg-[#Fff] w-full">
        <div className="flex items-center justify-between hover:cursor-pointer">
          <Link to="/">
            {" "}
            <div>
              <h1 className="font-bold text-[24px] font-inter hover:cursor-pointer">
                Duexe
              </h1>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center justify-center hover:cursor-pointer md:gap-x-8 lg:gap-x-16 text-[16px] font-normal">
            <p>Shop</p> <p className="hover:cursor-pointer">Flash Sales</p>
          ...
          <div className="flex items-center justify-center space-x-2 lg:space-x-4">
            <div className="  md:pr-3 bg-[#f5f5f5] shadow-sm hover:shadow-[0_7px_25px_rgba(0,0,0,0.08)] flex items-center justify-center rounded-lg pl-1 md:pl-3">
              <input
                type="text"
                className="outline-none bg-none py-2 w-50 md:w-40 lg:w-44"
              />
              <img
                src={search}
