...
const Hero = () => {
  return (
    <div className="px-2  md:px-4 lg:px-20 py-20 md:py-10 font-inter w-full">
      <div className="flex flex-col md:flex md:flex-row items-center justify-center md:items-center md:justify-between md:space-x-4">
        <div className="  text-center w-full">
          <h1 className="font-semibold text-[36px] text-center lg:pr-6">
            Transform Your Space Today
          </h1>
          <img src={stroke} alt="" className="pl-10 md:pl-0 lg:pl-16" />
        </div>
