...
const Service = () => {
  return (
    <div className="space-y-10 md:space-x-6 py-8 flex flex-col md:flex md:flex-row items-center justify-center md:justify-between px-2 md:px-6 lg:px-20 lg:py-20 md:py-10 py-4 w-full">
